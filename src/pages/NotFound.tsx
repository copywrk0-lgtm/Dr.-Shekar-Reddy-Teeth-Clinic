  ...
  return (
    <main className="grid min-h-[75vh] place-items-center px-5 pb-20 pt-32 sm:px-6">
      <section className="max-w-2xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-lg text-ink/65">The link may be outdated or the address may have been typed incorrectly. Choose a page below or request an appointment.</p>
